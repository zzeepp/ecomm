            ...
            <div class="tile-body">
                <div class="table-responsive">
                    <table class="table table-sm">
                        ...
                        <tbody>
                        <tr v-for="value in AttributeValuesList" :key="value.id">
                            <td
                                  style="width: 25%"
                                  class="text-center"
                            >{{ value.id }}
...
export default {
    ...
    methods: {
        loadValues() {
            ...
            let _this       = this;
            axios.post(
                  '/admin/attributes/get-values',
                  {
                      id: attributeId
                  })
                 .then(function (response) {
                     _this.AttributeValuesList = response.data;
                 })
        ...
        saveValue() {
            if (this.value === '') {
                ...
                axios.post(
                     ...
                     .then(function (response) {
                         _this.AttributeValuesList.push(response.data);
                         _this.resetValue();
        ...
        editAttributeValue(value) {
            ...
            this.key       = this.AttributeValuesList.indexOf(value);
        },
        updateValue() {
            if (this.value === '') {
                //     this.$swal("Error, Value for attribute is required.", {
                ...
                let _this       = this;
                axios.post(
                      '/admin/attributes/update-values',
                      {
                          id     : attributeId,
                          value  : _this.value,
                          price  : _this.price,
                     ...
                     .then(function (response) {
                         _this.AttributeValuesList.splice(
                               _this.key,
                               1);
                         _this.resetValue();
                         _this.AttributeValuesList.push(response.data);
        ...
        deleteAttributeValue(value) {
            ...
            let _this      = this;
            axios.post(
                  '/admin/attributes/delete-values',
                  {
                      id: _this.currentId
                  })
                 .then(function (response) {
