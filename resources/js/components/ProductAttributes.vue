            ...
            <div class="tile-body">
                <div class="table-responsive">
                    <table class="table table-sm">
                        ...
                        <tbody>
                        <tr v-for="pa in productAttributesList">
                            <td
                                  style="width: 25%"
                                  class="text-center"
                            >{{ pa.attribute_value }}
                            ...
                            >
                                <button
                                      ...
                                      @click="deleteProductAttribute(pa)"
                                >
    ...
    methods: {
        ...
        loadProductAttributes(id) {
            ...
            axios.post(
                 ...
                 .then(function (response) {
                     _this.productAttributesList = response.data;
                 })
                 .catch(function (error) {
                     console.log(error);
                 });
        ...
        addProductAttribute() {
            ...
            let data  = {
                ...
                attribute_value: this.currentValue,
