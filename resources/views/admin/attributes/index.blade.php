                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    >
                                        ...
                                        <a
                                                href="{{ route('admin.attributes.delete', $attribute->id) }}"
...
@push('scripts')
    <script
            ...
            src="{{ asset('backend/js/plugins/jquery.dataTables.min.js') }}"
    ></script>
    <script
            type="text/javascript"
            src="{{ asset('backend/js/plugins/dataTables.bootstrap.min.js') }}"
    ></script>
